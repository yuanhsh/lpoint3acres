...
- (void)updateToolbarItems {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        toolbar.tintColor = [UIColor colorWithRed:0 green:122.0/255.0 blue:1 alpha:1];
        ...
        self.navigationController.toolbar.tintColor = [UIColor colorWithRed:0 green:122.0/255.0 blue:1 alpha:1];
